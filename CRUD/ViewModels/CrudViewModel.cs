...
namespace CRUD.ViewModels
{
    ...
    {
        [ObservableProperty]
        private ObservableCollection<Question> wishes = new();
        ...
        {
            var wish = new Question { Definition = definition };
        ...
        [RelayCommand]
        private async Task Edit(Question wish)
        {
        ...
        [RelayCommand]
        private async Task Delete(Question wish)
        {
